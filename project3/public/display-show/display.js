...
socket.emit("my-role", {role: "display-show"});
...
socket.on("new-part-from-server", function(part){
  console.log("receivd", part)
  if(part.bodypart == 0){
    bodyImg = loadImage("../" + part.imgUrl);
  }else if(part.bodypart == 1){
    headImg = loadImage("../" + part.imgUrl);
  }else if(part.bodypart == 2){
    leftArmImg = loadImage("../" + part.imgUrl);
  }else if(part.bodypart == 3){
    rightArmImg = loadImage("../" + part.imgUrl);
  }else if(part.bodypart == 4){
    leftLegImg = loadImage("../" + part.imgUrl);
  }else if(part.bodypart == 5){
    rightLegImg = loadImage("../" + part.imgUrl);
  }
})
